 ...
 */
public class MaxEqualOrderedComparator implements Comparator<KeyFrameDescriptor, Double> {
    @Override
    public Double apply(KeyFrameDescriptor t1, KeyFrameDescriptor t2) {
        Double maxDist1, maxDist2;
        maxDist1 = new MaxOrderedComparator().apply(t1, t2);
        maxDist2 = new MaxOrderedComparator().apply(t2, t1);
