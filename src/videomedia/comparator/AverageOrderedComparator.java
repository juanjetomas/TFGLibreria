...
/**
 * Comparator class wich returns the average distance between every descriptor
 ...
 */
public class AverageOrderedComparator implements Comparator<KeyFrameDescriptor, Double> {
    @Override
    public Double apply(KeyFrameDescriptor t1, KeyFrameDescriptor t2) {
        ...
        return ComparatorTools.getAverage(distances);
    }
}
