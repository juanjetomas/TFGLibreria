 ...
 */
public class AverageEqualComparator implements Comparator<KeyFrameDescriptor, Double> {
    @Override
    public Double apply(KeyFrameDescriptor t1, KeyFrameDescriptor t2) {
        Double average1, average2;
        average1 = new AverageComparator().apply(t1, t2);
        average2 = new AverageComparator().apply(t2, t1);
