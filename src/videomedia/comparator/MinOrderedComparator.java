...
/**
 * Comparator class wich returns the minimum distance between every descriptor
 ...
 */
public class MinOrderedComparator implements Comparator<KeyFrameDescriptor, Double> {
    @Override
    public Double apply(KeyFrameDescriptor t1, KeyFrameDescriptor t2) {
        ...
        return ComparatorTools.getMin(distances);
    }
}
