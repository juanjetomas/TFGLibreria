 ...
 */
public class MedianEqualOrderedComparator implements Comparator<KeyFrameDescriptor, Double> {
    @Override
    public Double apply(KeyFrameDescriptor t1, KeyFrameDescriptor t2) {
        Double median1, median2;
        median1 = new MedianOrderedComparator().apply(t1, t2);
        median2 = new MedianOrderedComparator().apply(t2, t1);
